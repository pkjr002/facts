...
def filePATH(ssp,path): # Creates a list of file paths.
    ...
    # files=[path+f'wf1e/{ssp}/coupling.{ssp}.total.workflow.wf1e.global.nc',
    #        path+f'wf2e/{ssp}/coupling.{ssp}.total.workflow.wf2e.global.nc',
    #        path+f'wf3e/{ssp}/coupling.{ssp}.total.workflow.wf3e.global.nc',
    #        path+f'wf4/{ssp}/coupling.{ssp}.total.workflow.wf4.global.nc']
    # return files
