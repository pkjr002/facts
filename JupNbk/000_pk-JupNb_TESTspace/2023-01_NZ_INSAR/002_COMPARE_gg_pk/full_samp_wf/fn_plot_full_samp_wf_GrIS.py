...
def plot_full_samp_wf(ssp,folder,samp,component,loc):
    ...
    for i, wf in enumerate(WF):
        ...
        #
        fileG=fileNAME(pathG,"GIS")#'icesheets-ipccar6-ismipemuicesheet-{arg0}_GIS_localsl.nc'.format(arg0=ssp)
        if wf=='wf_4':
            fileP=fileNAME(pathP,"GIS")
        else: 
            fileP=fileNAME(pathP,"GrIS")#'nzOG.{arg0}.emuGrIS.emulandice.GrIS_localsl.nc'.format(arg0=ssp)
