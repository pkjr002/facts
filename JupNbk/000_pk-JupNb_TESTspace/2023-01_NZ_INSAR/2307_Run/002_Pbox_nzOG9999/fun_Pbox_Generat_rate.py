...
#
total = {
    "wf_1e": [f'total.workflow.wf1e.{region}_rates.nc'],
    "wf_1f": [f'total.workflow.wf1f.{region}_rates.nc'],
    "wf_2e": [f'total.workflow.wf2e.{region}_rates.nc'],
    "wf_2f": [f'total.workflow.wf2f.{region}_rates.nc'],
    "wf_3e": [f'total.workflow.wf3e.{region}_rates.nc'],
    "wf_3f": [f'total.workflow.wf3f.{region}_rates.nc'],
    "wf_4":  [f'total.workflow.wf4.{region}_rates.nc']
}
#......................................................
if region=='global':
	common_files = [
	    f'lws.ssp.landwaterstorage_{region}sl_rates.nc',
	    f'ocean.tlm.sterodynamics_{region}sl_rates.nc'
	]
if region=='local':
	common_files = [
	    f'lws.ssp.landwaterstorage_{region}sl_rates.nc',
	    f'ocean.tlm.sterodynamics_{region}sl_rates.nc',
	    f'NZInsarGPS.NZInsarGPS.verticallandmotion_localsl_rates.nc' 
	]
#......................................................

component = {
    "wf_1e": [
        f'emuGrIS.emulandice.GrIS_{region}sl_rates.nc',
        f'emuAIS.emulandice.AIS_{region}sl_rates.nc',
        f'emuglaciers.emulandice.glaciers_{region}sl_rates.nc',
        *common_files   
    ],
    "wf_1f": [
        f'GrIS1f.FittedISMIP.GrIS_GIS_{region}sl_rates.nc',
        f'ar5AIS.ipccar5.icesheets_AIS_{region}sl_rates.nc',
        f'ar5glaciers.ipccar5.glaciers_{region}sl_rates.nc',
        *common_files
    ],
    "wf_2e": [
        f'emuGrIS.emulandice.GrIS_{region}sl_rates.nc',
		# f'ar6larmip.ipccar6.larmipAIS_AIS_{region}sl.nc',
		f'larmip.larmip.AIS_{region}sl_rates.nc',
        f'emuglaciers.emulandice.glaciers_{region}sl_rates.nc',
        *common_files
    ],
    "wf_2f": [
    ...
    "wf_3e": [
        f'emuGrIS.emulandice.GrIS_{region}sl_rates.nc', 
        f'deconto21.deconto21.AIS_AIS_{region}sl_rates.nc', 
        f'emuglaciers.emulandice.glaciers_{region}sl_rates.nc', 
        *common_files
    ],
    "wf_3f": [
    ...
    "wf_4": [
        f'bamber19.bamber19.icesheets_GIS_{region}sl_rates.nc', 
        f'bamber19.bamber19.icesheets_AIS_{region}sl_rates.nc', 
        f'ar5glaciers.ipccar5.glaciers_{region}sl_rates.nc', 
        *common_files
    ],
}
...
def GenerateRateFiles(indir, tempdir, chunksize, outdir=None):
	...
	for this_file in infiles:
		...
		# Print the file name we're working on
