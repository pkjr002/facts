...
#
total = {
    "wf_1e": [f'total.workflow.wf1eNOVLM.{region}.nc'],
    "wf_1f": [f'total.workflow.wf1fNOVLM.{region}.nc'],
    "wf_2e": [f'total.workflow.wf2eNOVLM.{region}.nc'],
    "wf_2f": [f'total.workflow.wf2fNOVLM.{region}.nc'],
    "wf_3e": [f'total.workflow.wf3eNOVLM.{region}.nc'],
    "wf_3f": [f'total.workflow.wf3fNOVLM.{region}.nc'],
    "wf_4":  [f'total.workflow.wf4NOVLM.{region}.nc']
}
#......................................................
if region=='global':
	common_files = [
