...
''' InsarGPS_preprocess_verticallandmotion.py

This runs the preprocessing stage for the vertical land motion component of the InsarGPS
workflow.
...
def InsarGPS_preprocess_verticallandmotion(pipeline_id):
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the pre-processing stage for the InsarGPS vertical land motion workflow",\
	...
	InsarGPS_preprocess_verticallandmotion(args.pipeline_id)
