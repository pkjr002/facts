...
''' griddedVLM_postprocess_verticallandmotion.py

This runs the post-processing stage for the vertical land motion component of the griddedVLM
...
def griddedVLM_postprocess_verticallandmotion(nsamps, rng_seed, locationfilename, baseyear, pyear_start, pyear_end, pyear_step, chunksize, pipeline_id):
	...
	ncvar_attributes = {"description": "Local SLR contributions from vertical land motion according to griddedVLM workflow",
			"history": "Created " + time.ctime(time.time()),
			"source": "SLR Framework: griddedVLM workflow",
			"scenario": "NA",
			"baseyear": baseyear}
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the post-processing stage for the griddedVLM workflow",\
	epilog="Note: This is meant to be run as part of the griddedVLM module within the Framework for the Assessment of Changes To Sea-level (FACTS)")
	...
	griddedVLM_postprocess_verticallandmotion(args.nsamps, args.seed, args.locationfile, args.baseyear, args.pyear_start, args.pyear_end, args.pyear_step, args.chunksize, args.pipeline_id)
