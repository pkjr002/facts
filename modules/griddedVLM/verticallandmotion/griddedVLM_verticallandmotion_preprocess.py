...
''' griddedVLM_preprocess_verticallandmotion.py

This runs the preprocessing stage for the vertical land motion component of the griddedVLM
workflow.
...
def griddedVLM_preprocess_verticallandmotion(pipeline_id):
	...
	inputfile = os.path.join(os.path.dirname(__file__), "griddedVLM_rate_File.txt")
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the pre-processing stage for the griddedVLM vertical land motion workflow",\
	...
	griddedVLM_preprocess_verticallandmotion(args.pipeline_id)
