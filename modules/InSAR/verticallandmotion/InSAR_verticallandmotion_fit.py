...
''' InSAR_fit_verticallandmotion.py
...
def InSAR_fit_verticallandmotion(pipeline_id):
...
if __name__ == '__main__':	
	...
	parser = argparse.ArgumentParser(description="Run the fitting stage for the InSAR vertical land motion workflow",\
	...
	InSAR_fit_verticallandmotion(args.pipeline_id)
