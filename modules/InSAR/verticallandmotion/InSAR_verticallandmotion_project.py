...
''' InSAR_project_verticallandmotion.py
...
def InSAR_project_verticallandmotion(pipeline_id):
...
if __name__ == '__main__':	
	...
	parser = argparse.ArgumentParser(description="Run the projection stage for the InSAR vertical land motion workflow",\
	...
	InSAR_project_verticallandmotion(args.pipeline_id)
