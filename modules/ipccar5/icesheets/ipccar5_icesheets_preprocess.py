...
def ar5_preprocess_icesheets(scenario, startyr, tlm_flag, pipeline_id, climate_fname):
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the icesheets pre-processing stage for the AR5 Global SLR projection workflow",\
	epilog="Note: This is meant to be run as part of the Framework for the Assessment of Changes To Sea-level (FACTS)")
	
	# Scenario choices
	#scenario_choices = ['rcp85', 'rcp60', 'rcp45', 'rcp26', \
	#					'ssp119', 'ssp126', 'ssp129', 'ssp245', 'ssp370', 'ssp434', 'ssp460', 'ssp585']
	...
	ar5_preprocess_icesheets(args.scenario, args.baseyear, args.tlm_data, args.pipeline_id, args.climate_data_file)
