...
def ar5_fit_icesheets(pipeline_id):
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the icesheets fitting stage for the AR5 SLR projection workflow",\
	...
	ar5_fit_icesheets(args.pipeline_id)
