...
''' FittedISMIP_fit_icesheet.py

Fitting process for the FittedISMIP icesheet module.
...
def FittedISMIP_fit_icesheet(pipeline_id):
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the FittedISMIP icesheet fitting stage.",\
	...
	FittedISMIP_fit_icesheet(args.pipeline_id)
