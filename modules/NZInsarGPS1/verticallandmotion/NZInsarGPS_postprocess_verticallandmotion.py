...
''' NZInsarGPS_postprocess_verticallandmotion.py

This runs the post-processing stage for the vertical land motion component of the NZInsarGPS
...
def NZInsarGPS_postprocess_verticallandmotion(nsamps, rng_seed, locationfilename, baseyear, pyear_start, pyear_end, pyear_step, chunksize, pipeline_id):
	...
	ncvar_attributes = {"description": "Local SLR contributions from vertical land motion according to NZInsarGPS workflow",
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the post-processing stage for the NZInsarGPS vertical land motion workflow",\
	...
	NZInsarGPS_postprocess_verticallandmotion(args.nsamps, args.seed, args.locationfile, args.baseyear, args.pyear_start, args.pyear_end, args.pyear_step, args.chunksize, args.pipeline_id)
