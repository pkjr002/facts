...
def dp21_preprocess_icesheet(scenario, baseyear, pipeline_id):
...
if __name__ == '__main__':
	...
	parser.add_argument('--scenario', help="Emissions scenario of interest [default = rcp85]", choices=["rcp85", "rcp45", "rcp26", "ssp585", "ssp245", "ssp126"], default="spp585")
	...
	dp21_preprocess_icesheet(args.scenario, args.baseyear, args.pipeline_id)
