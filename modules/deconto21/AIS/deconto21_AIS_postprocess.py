...
def dp21_postprocess_icesheet(locationfilename, chunksize, pipeline_id):
	...
	ncvar_attributes = {"description": "Local SLR contributions from icesheets according to DP21 workflow",
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the post-processing stage for the DP21 icesheet SLR projection workflow",\
