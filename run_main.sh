...
echo -e "==> Started at: $(date --date=@$startOG)" > "$facts_dir/$fileOUT"
echo -e "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: \n" >> "$facts_dir/$fileOUT"
#
...
echo -e "EXPERIMENT subFOLDER:: "$EXP >> "$facts_dir/$fileOUT"
echo "EXPERIMENT:: "$exp >> "$facts_dir/$fileOUT"
echo " ............... " >> "$facts_dir/$fileOUT"
echo "Started at:: $(date --date=@$startOG)" >> "$facts_dir/$fileOUT"
echo "Ended at:: $(date --date=@$endOG)" >> "$facts_dir/$fileOUT"
