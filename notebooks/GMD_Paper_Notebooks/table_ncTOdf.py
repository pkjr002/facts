    ...
    for val in df.index.values:
        for scenario in enumerate(SCENARIO):
            ...
            if df.at[val,'dataID'] == 'cplng':
                ...
                # dataFOLDER  = '/scratch/pk695/FACTS/002_fork/facts/experiments.TEST/coupling/{arg1}/output/'.format(arg1=scenario[1])
                # dataFILE    = '{arg1}.'.format(arg1=scenario[1]) + df.at[val,'DataFile']
                # alex 
                dataFOLDER  = 'scratch/ar2208/branches/TotalingFix/facts/experiments/coupling.{arg1}/output'.format(arg1=scenario[1])
                dataFILE    = '{arg1}.'.format(arg1=scenario[1]) + df["DataFile"][val]
            #   
...
def wf_Table_nc(df,SCENARIO,EXPDATE,YEAR):
    ...
    for val in df.index.values: 
        for scenario in SCENARIO: 
            ...
            # dataFOLDER  = '/scratch/pk695/FACTS/002_fork/facts/experiments.TEST/coupling/{arg1}/output/'.format(arg1=scenario)
            # dataFILE    = '{arg1}.'.format(arg1=scenario) + df.at[val,'DataFile']
            # alex 
            dataFOLDER  = 'scratch/ar2208/branches/TotalingFix/facts/experiments/coupling.{arg1}/output'.format(arg1=scenario)
